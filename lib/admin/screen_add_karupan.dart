...
class ScreenAddKarupan extends StatefulWidget {
  State createState() {
    return Fragment1State();
  }
}
class Fragment1State extends State<ScreenAddKarupan> {
  ...
  String _dropdownUserCheckStatus="ใช้งาน";
  List<String> itemsCheckStatus=['ใช้งาน','ชำรุด','จำหน่าย','บริจาค'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          FlatButton(
            ...
            onPressed: () {
              ...
              if (year.isEmpty||
                ...
                _showAlertDialog('กรุณาอัพโหลดรูปภาพก่อน!');
              } else {
                sendData(
                    year,
                        department,
        ...
        title: Text('เพิ่มครุภัณฑ์', style: textStyleAppbar),
        centerTitle: true,
      ),
  ...
  Future<http.Response> callAddKarupan(department,
    ...
    final addUser = await http.post(
      Server().IPAddress + "/AddKarupan.php", // change with your API
      body: paramDic,
    );
